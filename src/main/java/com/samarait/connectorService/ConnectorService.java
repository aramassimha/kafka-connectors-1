...
public class ConnectorService {
	...
	private final String KAFKA_CONNECT_URL = "http://localhost:8083/connectors";
	...
	public String createPostgreSQLSinkConnector() {
		...
		String connectorConfig = """
				...
				"config": {
				    ...
				    "connection.url": "jdbc:postgresql://postgres:5432/sink-connector",
				    "connection.user": "postgres",
				    "connection.password": "password",
				    "topics": "mysql-users"
				    "table.name.format": "upsert",
	...
	private String createConnector(String configJson) {
		...
		try {
			...
			HttpEntity<String> request = new HttpEntity<>(configJson, header);
